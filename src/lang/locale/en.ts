...
export default {
  ...
  'Export current file to DOCX': 'Export current file to DOCX',
  'Exporting to DOCX...': 'Exporting to DOCX...',
  'Successfully exported to ': 'Successfully exported to ',
  'DOCX export failed: ': 'DOCX export failed: ',
  'Export': 'Export',
  'Convert to docx file.': 'Convert to docx file.',
  'Export format settings': 'Export format settings',
  ...
  'Support citations wrapped in wiki-links (e.g. [[@citekey]]).': 'Support citations wrapped in wiki-links (e.g. [[@citekey]]).',
